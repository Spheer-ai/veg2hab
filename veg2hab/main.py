...
def run():
    wwl_filepath = resource_filename('veg2hab', 'package_data/opgeschoonde_waswordt.xlsx')
    wwl = WasWordtLijst.from_excel(wwl_filepath)

    def_filepath = resource_filename('veg2hab', 'package_data/opgeschoonde_definitietabel.xlsx')
